...
function Register() {
    ...
    return ( 
        <div className="w-full h-full flex justify-center items-center mt-12">
            <div>
            <ToastContainer />
                <form onSubmit={handleSubmit} className="w-[450px] min-h-[550px] shadow-md flex flex-col bg-slate-50 rounded overflow-hidden gap-3">
                    ...
                    <div className="flex flex-col p-4 gap-3">
                        ...
                        <div className="w-full">
                            <input type="email" className="w-full p-2 rounded focus:outline-slate-200 bg-slate-200" required placeholder="btl@gamil.com"/>
                        </div>
                        <div>Password</div>
                        <div className="w-full">
